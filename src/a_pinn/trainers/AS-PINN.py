...
class AutoScaleTrainer:
    def __init__(
        ...
        net = make_scaled_fnn([2] + [hidden_units]*hidden_layers + [pde_module.output_size])
    ...
    def train(self, iterations: int = 20_000) -> None:
        ...
        self.model.save(self.output_dir / "model_autoscale.ckpt")
        ...
        plt.figure()
        plt.plot(df["iterations"], df["loss"], label="Total Loss (AutoScale)")
